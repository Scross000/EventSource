...
<div class="body">
	<div class="row">
		...
		<div class="col-8">
			<form action="">
				<input class="form-control searchbox" type="text" placeholder="Search Event...">
				<button type="submit" class="btn btn-dark searchbtn btn-black"><i class="fas fa-search"></i></button>
			</form>
			<ul>
